...
const FEATURES = [
  ...
  { icon: Zap, title: 'دفع فوري', desc: 'المبلغ يصل محفظتك بعد 48 ساعة من كل بيعة عبر تحويل بنكي' },
          ...
          <section className="pb-8">
            <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-100 dark:border-neutral-800 p-5">
              ...
              <p className="text-xs text-neutral-400 mt-3 bg-neutral-50 dark:bg-neutral-800 rounded-xl p-3">
                💡 الـ 9% تغطي رسوم معالجة الدفع فقط — Wibya لا تأخذ ربحاً من مبيعاتك.
              </p>
            </div>
          </section>
          ...
          <section className="pb-8" aria-labelledby="faq">
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  q: 'كيف أستلم أموالي؟',
                  a: 'عبر تحويل بنكي مباشرة. تطلب السحب من لوحتك والحد الأدنى $10. يصل خلال 1-3 أيام عمل.',
                },
                {
