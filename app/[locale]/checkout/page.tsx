...
function CheckoutContent() {
  ...
  if (ordered) return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-neutral-400 text-sm mb-2">سيتواصل معك البائع قريباً لتأكيد التسليم</p>
      ...
      <div className="flex gap-3 w-full max-w-xs">
        ...
        <button onClick={() => router.push('/orders')} className="flex-1 py-3 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium rounded-2xl text-sm">طلباتي</button>
      </div>
    </div>
  )
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="px-4 py-5 pb-36 max-w-lg mx-auto space-y-4">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-100 dark:border-neutral-800 p-4 space-y-4">
          ...
          <div>
            ...
            <input value={address} onChange={e => setAddress(e.target.value)} className="input" placeholder="الحي، الشارع، رقم البناية..." />
          </div>
          <div>
          ...
          <div>
            ...
            <input value={phone} onChange={e => setPhone(e.target.value)} className="input" placeholder="+212..." dir="ltr" />
          </div>
          <div>
            <label className="text-xs font-medium text-neutral-500 dark:text-neutral-400 mb-1 block">ملاحظات (اختياري)</label>
            <textarea value={notes} onChange={e => setNotes(e.target.value)} className="input resize-none" rows={2} placeholder="أي تفاصيل إضافية..." />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-100 dark:border-neutral-800 p-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-neutral-400">سعر المنتج</span>
        ...
        <div className="flex items-center gap-3 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 rounded-2xl p-3">
          ...
          <div>
            ...
            <p className="text-xs text-green-600 dark:text-green-500">ضمان استرجاع في حال وجود عيب</p>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 start-0 end-0 bg-white/90 dark:bg-neutral-950/90 backdrop-blur-xl border-t border-neutral-100 dark:border-neutral-800 p-4">
        ...
        <p className="text-center text-xs text-neutral-400 mt-2">الدفع عند الاستلام · آمن ومضمون</p>
      </div>
    </div>
  )
}
