      ...
      <main className="pb-24">
        ...
        <div className="px-4 py-5">
          <div className="flex items-center justify-between mb-3">
            <h2 className="font-bold text-neutral-900 dark:text-white text-sm">الفئات</h2>
          </div>
        ...
        {featured && featured.length > 0 && (
          <section className="px-4 mb-6" aria-labelledby="featured-title">
            <div className="flex items-center justify-between mb-3">
              <h2 id="featured-title" className="font-bold text-neutral-900 dark:text-white text-sm flex items-center gap-2">
        ...
        {topDevelopers && topDevelopers.length > 0 && (
          <section className="px-4 mt-6" aria-labelledby="developers-title">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/developers" className="text-xs text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300">
                عرض الكل
              </Link>
            </div>
            <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-2">
              {topDevelopers.map((dev: any) => (
                <Link key={dev.id} href={`/developer/${dev.id}`}>
                  <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-100 dark:border-neutral-800 p-4 text-center w-32 shrink-0 hover:border-neutral-300 dark:hover:border-neutral-600 transition-colors">
